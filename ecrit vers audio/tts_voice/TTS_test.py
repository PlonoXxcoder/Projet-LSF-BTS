...
if __name__ == "__main__":
    ...
    print("-" * 30)
    print("IMPORTANT : Vérifiez les identifiants des voix anglaises dans l'Enum 'Voice' du code.")
    print(f"Actuellement : EN_MALE='{Voice.EN_MALE.value}', EN_FEMALE='{Voice.EN_FEMALE.value}'")
